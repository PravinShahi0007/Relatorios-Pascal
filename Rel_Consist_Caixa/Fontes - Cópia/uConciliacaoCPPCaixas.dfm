object frmRelDivCPP_Caixa: TfrmRelDivCPP_Caixa
  Left = 190
  Top = 205
  Width = 523
  Height = 401
  BorderIcons = [biSystemMenu]
  Caption = 'Relat'#243'rio de Diverg'#234'ncias Cr'#233'dito Pessoal x Caixa'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Panel9: TPanel
      ...
      object edtContaInicial: TMaskEdit
        Left = 139
        Top = 9
        Width = 339
        Height = 21
  ...
  object StpConciliacao: TStoredProc
    DatabaseName = 'database1'
    SessionName = 'Session1_2'
    StoredProcName = 'GRZ_REL_DIVERG_CPP_CAIXAS'
    Left = 38
    Top = 7
    ParamData = <
      item
  ...
  object pprRelatorio: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel10: TppLabel
        UserName = 'Label10'
        Caption = 'Relat'#243'rio de Divergencias Cr'#233'dito Pessoal X Caixa'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Times New Roman'
        Font.Size = 10
