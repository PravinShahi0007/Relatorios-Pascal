       ...
       cursor c_venda_mvto is
         ...
         r_receb_juro_mvto c_receb_juro_mvto%ROWTYPE;
          ...
          BEGIN
	       ...
	       pi_conta_cb := '467,438,439,478,479,556,710,734';
	       pi_conta_nt := 229;
	     ...
	     begin
	         ...
	         if (r_venda_mvto.cod_oper = 300) or (r_venda_mvto.cod_oper = 4300) then
	        	 ...
	        	 if ((r_venda_mvto.cod_portador = 2900) or (r_venda_mvto.cod_portador = 2910) or
	        	     ...
	        	     (r_venda_mvto.cod_portador = 2940) or (r_venda_mvto.cod_portador = 2950) or
	        	     (r_venda_mvto.cod_portador = 2960) or (r_venda_mvto.cod_portador = 2970) or
					 (r_venda_mvto.cod_portador = 2990) )then
