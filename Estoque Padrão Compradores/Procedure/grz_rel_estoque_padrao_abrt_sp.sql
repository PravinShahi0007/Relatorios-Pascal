/*------------------------------------------------------------------------
  Procedure.: grz_rel_estoque_padrao_abrt_sp
...
------------------------------------------------------------------------*/
create or replace procedure grz_rel_estoque_padrao_abrt_sp (pi_opcao in varchar2)
is
begin
     declare
            pi_empresa          number;
     ...
     cursor c_est_venda is
            ...
            and (ge.cod_unidade  = es.cod_unidade or  es.cod_unidade in (select uni.cod_unidade_para
     ...
     cursor c_est is
            ...
            and (a.cod_unidade=ge.cod_unidade or a.cod_unidade in (select uni.cod_unidade_para
                                                                   from grz_lojas_unificadas_cia uni
                                                                   where uni.cod_unidade_de = ge.cod_unidade))
     ...
     cursor c_est_direta is
            select substr(b.cod_completo,1,wqtd_casas) cod_completo
                   ,substr(b.cod_editado,1,wqtd_casas1) cod_editado
                   ,decode(pi_lista_unidade,1,d.cod_unidade,pi_grupo) cod_unidade
            ...
            and (d.cod_unidade = ge.cod_unidade or d.cod_unidade in (select uni.cod_unidade_para
                                                                     from grz_lojas_unificadas_cia uni
                                                                     where uni.cod_unidade_de = ge.cod_unidade))
            and ge.cod_grupo   = pi_grupo
            and ge.cod_emp     = pi_empresa
            ...
            group by substr(b.cod_completo,1,wqtd_casas)
                     ,substr(b.cod_editado,1,wqtd_casas1)
                     ,decode(pi_lista_unidade,1,d.cod_unidade,pi_grupo)

            union

            select substr(b.cod_completo,1,wqtd_casas) cod_completo
                   ,substr(b.cod_editado,1,wqtd_casas1) cod_editado
                   ,decode(pi_lista_unidade,1,o.cod_unidade,pi_grupo) cod_unidade
            ...
            and (o.cod_unidade = ge.cod_unidade or o.cod_unidade in (select uni.cod_unidade_para
                                                                     from grz_lojas_unificadas_cia uni
                                                                     where uni.cod_unidade_de = ge.cod_unidade))
            and ge.cod_grupo = pi_grupo
            and ge.cod_emp = pi_empresa
            ...
            group by substr(b.cod_completo,1,wQtd_Casas)
                     ,substr(b.cod_editado,1,wQtd_Casas1)
                     ,decode(pi_lista_unidade,1,o.cod_unidade,pi_grupo);
...
end grz_rel_estoque_padrao_abrt_sp;
