CREATE OR REPLACE PROCEDURE GRZ_SP_INTERFACE_CADCLIENTES
	  ...
	  CURSOR c_clientes_sislog IS
	           select *
                  ...
                  where a.num_rede       >= pi_rede_ini
                    ...
                    --and a.num_loja       not in (53,44,97,158)
                    --and a.cod_cliente     = 0
                    --and a.cod_cliente in (16947075,22911403,22911411,21349066,21349074)
...
--                            wTem_Alt_Unidade  := 1;
			...
			while iCount < 27 loop
				   ...
				   wVlr_Coluna := substr(lpad(r_clientes_sislog.cod_cartao_adic,3,'0'),3,1);
			           ...
			           wVlr_coluna := to_char(r_clientes_sislog.vlr_liq_patrimonio,'FM9999990D00');
			       end if;
