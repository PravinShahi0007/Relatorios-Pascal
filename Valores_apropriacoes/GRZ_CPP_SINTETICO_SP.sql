CREATE OR REPLACE PROCEDURE GRZ_CPP_SINTETICO2_SP  
  ...
  DECLARE
	...
	cursor c_apropriacao2 is
                 								
						SELECT A.DTA_APRO DTA_APROPRIACAO
							,SUM(A.VLR_APRO) VLR_RENDAS
	...
	r_apropriacao2 c_apropriacao2%rowtype;
      ...
      if(wRede = '') then
        ...
        wRede := to_char(pi_grupo);
	       ...
	       nome_arq := 'RENDAS_CPP_SINTETICO_'||AUXILIAR||'_'||wRede||'.txt';
	       ...
	       OPEN c_apropriacao2;
	       FETCH c_apropriacao2 INTO r_apropriacao2;
	       WHILE c_apropriacao2%FOUND LOOP
	       BEGIN
          	  /*
          	    if (wPri_Vez = 0) or
		   ...
		   */
		        ...
		        UTL_FILE.PUT_LINE(file_handle,to_char(r_apropriacao2.DTA_APROPRIACAO)||';'
						||to_char(r_apropriacao2.VLR_RENDAS)||';');
		    
		    ----wDta_Inicial := wDta_Inicial + 1;
               END;
               FETCH c_apropriacao2 INTO r_apropriacao2;
               END LOOP;
               CLOSE c_apropriacao2;               
