CREATE OR REPLACE PROCEDURE GRZ_CRE_SINTETICO_SP  
  ...
  if (SUBSTR(pi_grupo,2,2) = 10) then
      ...
      if(wRede = '') then
        ...
        wRede := to_char(pi_grupo);
	       ...
	       nome_arq := 'RENDAS_CRE_SINTETICO_'||AUXILIAR||'_'||wRede||'.txt';
		   ...
		   */
		        ...
		        UTL_FILE.PUT_LINE(file_handle,to_char(r_apropriacao.DTA_APROPRIACAO)||';'
						||to_char(r_apropriacao.VLR_RENDAS)||';');
