...
uses
  ...
  FireDAC.DatS, FireDAC.DApt.Intf, FireDAC.DApt, FireDAC.Comp.DataSet, Encryp,
  uCarregaSenha;
...
begin
    ...
    sCabecalho := sCabecalho + '<th>Qtd. Peças Estoque</th>';
    sCabecalho := sCabecalho + '<th>Valor Estoque</th>';
    sCabecalho := sCabecalho + '<th>Qtd. Cód. Barras Venda</th>';
...
procedure TfrmEstoqueCD.CarregaParamsBanco;
