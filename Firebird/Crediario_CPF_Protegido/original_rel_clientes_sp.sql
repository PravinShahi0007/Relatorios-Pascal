...
create or alter procedure rel_clientes_sp
(
...
begin
     ...
     begin
         ...
         begin
              ...
              for select cre_clientes.tip_pessoa,
                  ...
                  into :itip_pessoa,:icod_cliente,:ides_cliente,:ides_endereco,:ides_bairro,
                       :icod_cidade,:ides_fone_resid,:ides_fone_celular,:ides_fone_celular2,
                       :ides_fone_comerc,:dta_cadastro,:dta_alteracao,:icod_unidade,
                       :ivlr_limite,:ivlr_renda,:cod_pes_aprov_cad,:cod_pes_digit_cad do
              begin
          ...
          begin
               ...
               for select cre_clientes.tip_pessoa,
                   ...
                   into :itip_pessoa,:icod_cliente,:ides_cliente,:ides_endereco,:ides_bairro,
                        :icod_cidade,:ides_fone_resid,:ides_fone_celular,:ides_fone_celular2,
                        :ides_fone_comerc,:dta_cadastro,:dta_alteracao,:icod_unidade,
                        :ivlr_limite,:ivlr_renda,:dta_pri_compra,:cod_pes_aprov_cad,:cod_pes_digit_cad do
               begin
                    if ((icod_uni_cli = 999) or (icod_uni_cli = icod_unidade)) then
                    begin
     ...
     begin /*'ambos','cadastrado','alterado',novos;*/
          if(iorder > 1 )then
          begin
               statuscliente = 'AMBOS';
               for select cre_clientes.tip_pessoa,
