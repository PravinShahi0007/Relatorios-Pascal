...
begin
     // Transfere dados...
     dtmVendaAVista.ARQUIVOINI.BASEDADOS := Trim(edtBase.Text);
     dtmVendaAVista.ARQUIVOINI.USUARIO := Trim(edtUsuario.Text);
     dtmVendaAVista.ARQUIVOINI.SENHA := Trim(edtSenha.Text);
     dtmVendaAVista.USUARIO.APARECIA := Trim(cbxEstilos.Items[cbxEstilos.ItemIndex]);

     dtmVendaAVista.Escreve_Dados_INI(Sender);
...
begin
     ...
     try
        ...
        cbxEstilos.ItemIndex := cbxEstilos.Items.IndexOf(dtmVendaAVista.USUARIO.APARECIA);
     finally
...
begin
      ...
      dtmVendaAVista.USUARIO.APARECIA := cbxEstilos.Text;
...
begin
     pnlUsuario.Caption := '  Usuário: '+dtmVendaAVista.USUARIO.USUARIO;
     edtBase.Text := dtmVendaAVista.ARQUIVOINI.BASEDADOS;
     edtUsuario.Text := dtmVendaAVista.ARQUIVOINI.USUARIO;
     edtSenha.Text := dtmVendaAVista.ARQUIVOINI.SENHA;
