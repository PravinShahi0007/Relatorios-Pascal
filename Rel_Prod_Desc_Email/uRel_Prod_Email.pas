...
begin
  ...
  {como a máquina é do IP 172, a conexão remota com o 32 não da certo
   então tem que mudar a conexão para 192 para o executável funcionar
   caso isso não aconteça vai dar um erro de conexão com o banco com
   a mensagem da linha 275 do código}

  try
         //MONTANDO O CABEÇALHO TA TABELA HTLM
         sCabecalho := ''                       +
                       '<tr>'                   +
                       '<th>Comprador</th>'     +
                       '<th>Itens</th>'         +
         ...
         //MONTANDO A PARTE INICIAL DO HTML COM OS TÍTULOS
         sHtml := ''                                                                                                                                     +
                  '<html>'                                                                                                                               +
                  '<head>'                                                                                                                               +
                  ...
                  '<tr>'                                                                                                                                 +
                  '<td align="center" colspan="13"><p><b><font face="arial" size="3" color="	#000000">Relatório de Estoque CD</font></b></p></td>'      +
                  '</tr>'                                                                                                                                ;

         //JUNTANDO A PARTE INICIAL DO HTML COM O CABEÇALHO
  ...
  frmRel_Prod_Desc_Email.qryConsulta.SQL.Text :=  'select p.des_pessoa "Comprador"                                                '+
    ...
    //CASO ACONTEÇA ALGUM ERRO VAI APARECER NA TELA
    ...
    iRegistros := frmRel_Prod_Desc_Email.qryConsulta.RecordCount;
         //CASO NÃO HOUVER NENHUM REGISTRO ENCONTRADO
         if  frmRel_Prod_Desc_Email.qryConsulta.RecordCount = 0 then
             ...
             //APONTANDO PARA O PRIMEIRO REGISTRO ENCONTRADO NO BANCO DE DADOS E PASSANDO OS PARÂMETROS
             frmRel_Prod_Desc_Email.qryConsulta.First;
             //FAZ PERCORRER A QUERY INTEIRA ATÉ A ÚLTIMA LINHA, PEGANDO PARÂMETROS A CADA LINHA PASSADA
             ...
             begin
                 ...
                 sDescricao   := frmRel_Prod_Desc_Email.qryConsulta.FieldByName('Descrição').AsString;
                 ...
                 sPadrao      := frmRel_Prod_Desc_Email.qryConsulta.FieldByName('Padrão').AsString;

                 //PASSA OS PARÂMETROS DA LINHA ENCONTRADA PRA VARIÁVEL sTabela
      ...
      begin
       ...
       //PEGA OS PARÂMETROS LISTADOS NA PASTA DO ARQUIVO CONFIG.INI E O CORPO DE TEXTO HTML
...
//PEGA OS PARÂMETROS LISTADOS NA PASTA DO ARQUIVO CONFIG.INI
...
//FAZ A CONEXÃO COM O BANCO DE DADOS ('nl') POIS É ORACLE
begin
   CarregaParametros;
       try
    ...
    //FAZ O PROGRAMA CLICAR DIRETO NO BOTÃO PARA O ENVIO DO E-MAIL
   // CarregaParametros;
